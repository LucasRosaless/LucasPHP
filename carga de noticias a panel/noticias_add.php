...
$registros = tomarRegistrosCondicion($mysqli, "noticias", "id", "asc", "mostrar = '1'");
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="table-responsive">
									...
									<form action="noticias_add_java.php" method="post" enctype="multipart/form-data" name="form1">
															...
															<tr>
																<td>
																	...
																	<label class="field" style="width:100%">
																		<textarea name="titulo" cols="1" rows="1" id="titulo" style="width:100%"><?php echo utf8_decode($registro["titulo"]); ?></textarea>
																	</label>
 ...
 -->
																...
																<td>
																	<select name="categoria" id="categoria">
																		...
																		<? foreach ($catssss as $cate) { ?>
																			<option value="<?= $cate['id']; ?>"><?= utf8_encode($cate['nombre']); ?></option>
																		<? } ?>
																	</select><br><br>
																</td>
															</tr>
															...
															<tr>
																<td>
																	...
																	Fuente
																	<label class="field" style="width:100%">
																		<input name="fuente" type="text" id="fuente" style="width:100%">
																	</label>
															...
															<!-- <tr>
																<td><BR><BR>GALERÍA DE LA NOTICIA <BR>
															...
															<tr>
																<td><span class="contentbox">
																		<input name="submit" type="submit" class="btn" value="Crear noticia" />
